...
namespace HR_KD.Migrations
{
    ...
    [Migration("20250520133359_ChangeDateTimetoTimeOnlyChamCongGioRaVao")]
    partial class ChangeDateTimetoTimeOnlyChamCongGioRaVao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CauHinhPhepNam", b =>
                {
                    ...
                    b.Property<int>("SoNgayPhepMacDinh")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CauHinhPhepNam", (string)null);
                });

            modelBuilder.Entity("ChinhSachPhepNam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ApDungTuNam")
                        .HasColumnType("int");

                    b.Property<bool>("ConHieuLuc")
                        .HasColumnType("bit");

                    b.Property<int>("SoNam")
                        .HasColumnType("int");

                    b.Property<int>("SoNgayCongThem")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ChinhSachPhepNam", (string)null);
                });
            ...
            modelBuilder.Entity("HR_KD.Data.BangLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("NgayDuyetGD")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("NgayDuyetKT")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("NgayDuyetNV")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("NgayGuiKT")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("NgayGuiNV")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("NgayTao")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("NgayTraVeTuGD")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("NgayTraVeTuKT")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("NgayTuChoiNV")
                        .HasColumnType("datetime2");

                    b.Property<string>("NguoiDuyetGD")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiDuyetKT")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiDuyetNV")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiGuiKT")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiGuiNV")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiTao")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiTraVeGD")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiTraVeKT")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiTraVeTuGD")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiTraVeTuKT")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiTuChoiNV")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HR_KD.Data.CauHinhPhep_ChinhSach", b =>
                {
                    b.Property<int>("CauHinhPhepNamId")
                        .HasColumnType("int");

                    b.Property<int>("ChinhSachPhepNamId")
                        .HasColumnType("int");

                    b.HasKey("CauHinhPhepNamId", "ChinhSachPhepNamId");

                    b.HasIndex("ChinhSachPhepNamId");

                    b.ToTable("CauHinhPhep_ChinhSach", (string)null);
                });
            ...
            modelBuilder.Entity("HR_KD.Data.ChamCongGioRaVao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HR_KD.Data.GioThieu", b =>
                {
                    b.Property<int>("MaGioThieu")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaGioThieu"));
                    ...
                    b.Property<DateOnly>("NgayThieu")
                        .HasColumnType("date");

                    b.Property<decimal>("TongGioThieu")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HR_KD.Data.LamBu", b =>
                {
                    b.Property<int>("MaLamBu")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaLamBu"));
            ...
            modelBuilder.Entity("HR_KD.Data.LichLamViec", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HR_KD.Data.LoaiNgayNghi", b =>
                {
                    ...
                    b.Property<int?>("SoLanDangKyToiDa")
                        .HasColumnType("int");

                    b.Property<int?>("SoNgayNghiToiDa")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HR_KD.Data.NgayLeCoDinh", b =>
                {
                    b.Property<int>("MaNgayLe")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PhepNamNhanVien", b =>
                {
                    ...
                    b.Property<decimal>("SoNgayChuaSuDung")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("HR_KD.Data.CauHinhPhep_ChinhSach", b =>
                {
                    b.HasOne("CauHinhPhepNam", "CauHinhPhepNam")
                        .WithMany("CauHinhPhep_ChinhSachs")
                        .HasForeignKey("CauHinhPhepNamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_CauHinhPhep_ChinhSach_CauHinhPhepNam");

                    b.HasOne("ChinhSachPhepNam", "ChinhSachPhepNam")
                        .WithMany("CauHinhPhep_ChinhSachs")
                        .HasForeignKey("ChinhSachPhepNamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
